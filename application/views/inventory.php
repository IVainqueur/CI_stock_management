...
<body>
    <div class="main px-[4em]">
        ...
        <form action="<?php echo base_url('inventory') ?>" method="get" class="flex flex-row gap-3 items-center">
            ...
            <img src="<?=base_url().'images/bx-printer.svg'?>" alt="" class="p-2 rounded h-10 w-10 hover:bg-slate-200  hover:rounded-full" onclick="location.href=`<?=base_url('inventory').'?print'?>`">
        </form>
