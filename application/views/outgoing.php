...
<body>
    <div class="main px-[4em]">
        <div class="titleDIV flex flex-row items-center justify-around gap-1 m-auto mt-5 bg-slate-100 p-2 rounded">
            <h3 class="text-xl font-bold">Outgoing products</h3>
            <div class="filters flex flex-row items-center">
                <a href="<?php echo base_url('outgoing') . "?sort=ASC" ?>" style="text-decoration: none;">
                ...
                <a href="<?php echo base_url('outgoing/add_outgoing') ?>" style="text-decoration: none;">
        ...
        <form action="<?php echo base_url('outgoing') ?>" method="get" class="flex flex-row gap-3 items-center">
            ...
            <img src="<?=base_url().'images/bx-printer.svg'?>" alt="" class="p-2 rounded h-10 w-10 hover:bg-slate-200  hover:rounded-full" onclick="location.href=`<?=base_url('outgoing').'?print'?>`">
        </form>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="p-2">
                                <a href="<?php echo base_url('outgoing/delete')."/".$product->productId ?>"><i class='bx bx-trash-alt text-red-400 text-2xl mr-1 p-1 h-10 w-10 flex justify-center items-center rounded-3xl hover:bg-slate-200'></i></a>
                                <a href="<?php echo base_url('outgoing/edit')."/".$product->productId ?>"><i class='bx bx-pencil text-blue-400 text-2xl p-1 h-10 w-10 flex justify-center items-center rounded-3xl hover:bg-slate-200'></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
