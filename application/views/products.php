    ...
    <div class="main px-[4em]">
        <div class="titleDIV flex flex-row items-center justify-around gap-1 m-auto mt-5 bg-slate-100 p-2 rounded">
            ...
            <div class="filters flex flex-row items-center">
                <a href="<?php echo base_url('products') . "?sort=ASC" ?>" style="text-decoration: none;">
                ...
                <a href="<?php echo base_url('products/new') ?>" style="text-decoration: none;">
        ...
        <div class="Table m-auto">
            <table>
                <thead class="bg-slate-600 text-white">
                    ...
                    <th class="p-2 pt-4 pb-4">Name</th>
                    <th class="p-2 pt-4 pb-4">Brand</th>
                    <th class="p-2 pt-4 pb-4">Supplier_phone</th>
                    <th class="p-2 pt-4 pb-4">Supplier</th>
                    <th class="p-2 pt-4 pb-4">Added on</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="p-2"><?= $product->supplier_phone ?></td>
                            <td class="p-2"><?= $product->supplier ?></td>
                            <td class="p-2"><?php $date = date("dS M Y", strtotime($product->added_date)); echo $date; ?></td>
                            <td class="p-2">
                                <a href="<?php echo base_url('products/delete')."/".$product->productId ?>"><i class='bx bx-trash-alt text-red-400 text-2xl mr-1 p-1 h-10 w-10 flex justify-center items-center rounded-3xl hover:bg-slate-200'></i></a>
                                <a href="<?php echo base_url('products/edit')."/".$product->productId ?>"><i class='bx bx-pencil text-blue-400 text-2xl p-1 h-10 w-10 flex justify-center items-center rounded-3xl hover:bg-slate-200'></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
